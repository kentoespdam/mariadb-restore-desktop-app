...
// decision, and either wipes the catalog or returns a user-canceled
// error.
package recovery
...
var ErrUserCancelled = errors.New("recovery: user canceled")
...
type Modal interface {
	// Show blocks until the user makes a decision or ctx is canceled.
