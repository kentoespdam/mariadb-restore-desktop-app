...
## Knowledge Gaps
- **70 isolated node(s):** `Always Do`, `Architecture Overview`, `Build & Test`, `CLI`, `Conventions & Patterns` (+65 more)
...
- **What connects `Always Do`, `Architecture Overview`, `Build & Test` to the rest of the system?**
